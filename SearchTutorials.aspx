<%@ Page Title="" Language="C#" MasterPageFile="MA.master"
    AutoEventWireup="true" CodeFile="SearchTutorials.aspx.cs" Inherits="SearchTutorials" %>
    ...
    <div class="search">
       ...
       <!-- <script type="text/javascript">
            window.onload = function () {
                ...
                TweenLite.to(logo, 5, { ease: "632px" });
            }
        </script>
        -->
        <asp:TextBox ID="searchbox" class="speech-input" runat="server" placeholder="search tutorials using voice commands" type="text" TextMode="MultiLine" Height="40px" Width="1000px"></asp:TextBox>
