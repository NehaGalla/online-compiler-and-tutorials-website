...
public partial class c_quiz_operators : System.Web.UI.Page
{
    ...
    protected void BindQuestions()
    {
        ...
        SqlCommand getquestions = new SqlCommand("select top 25 percent * from quiz_questions where type='operators' order by NEWID()");
