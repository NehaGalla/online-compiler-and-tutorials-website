...
public partial class c_quiz_variables : System.Web.UI.Page
{
    ...
    protected void BindQuestions()
    {
        ...
        SqlCommand getquestions = new SqlCommand("select top 55 percent * from quiz_questions where type='variables' order by NEWID()");
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        if (Page.IsValid)
        {
            ...
            SqlCommand insertentrycmd = new SqlCommand("insert into " + quizresponsestable + " (userid, correctanswers, wronganswers, status) values (@userid, @correctanswers, @wronganswers, @status);SELECT CAST(scope_identity() AS int)");
